...
#' First and foremost, Assistant is generally installed by default or readily
...
#' }
theme_allen_bw <- function(base_family="Assistant", base_size = 12.5,
  ...
  if (inherits(grid, "character") | grid == TRUE) {
    ...
    ret <-  ret + theme(rect = element_rect(fill = "transparent"),
  ...
  xj <- switch(tolower(substr(axis_title_just, 1, 1)), b=0, l=1, m=0.5, c=0.5, r=0, t=1)
